...
parser.add_argument('--nhid', type=int, default=77,
                    help='number of hidden units per layer (default: 77)')
...
channel_size = args.nhid
# model = TCN(input_channels, n_classes, channel_sizes, kernel_size=kernel_size, dropout=dropout)
model = LSTMNet(input_channels, n_classes, channel_size, num_layers=2)
